...
class PaymentTransaction(models.Model):
    ...
    def _prepare_account_payment_vals(self):
        _logger.info("_prepare_account_payment_vals")
        self.ensure_one()
        return {
            'amount': self.amount,
    ...
    def get_last_transaction(self):
        _logger.info("get_last_transaction")
    ...
    def _get_processing_info(self):
        _logger.info("_get_processing_info")
    ...
    def _get_payment_transaction_sent_message(self):
        _logger.info("_get_payment_transaction_sent_message")
        self.ensure_one()
    ...
    def _get_payment_transaction_received_message(self):
        _logger.info("_get_payment_transaction_received_message")
        self.ensure_one()
    ...
    def _log_payment_transaction_sent(self):
        _logger.info("_log_payment_transaction_sent")
    ...
    def _log_payment_transaction_received(self):
        _logger.info("_log_payment_transaction_received")
    ...
    def _filter_transaction_state(self, allowed_states, target_state):
        _logger.info("_filter_transaction_state")
        ...
        _logger.info("tx_to_process--> " + str(tx_to_process))
        _logger.info("tx_to_process--> " + str(tx_already_processed))
        _logger.info("tx_to_process--> " + str(tx_wrong_state))
        return (tx_to_process, tx_already_processed, tx_wrong_state)

    def _set_transaction_pending(self):
        _logger.info("_set_transaction_pending")
    ...
    def _set_transaction_authorized(self):
        _logger.info("_set_transaction_authorized")
    ...
    def _reconcile_after_transaction_done(self):
        ...
        _logger.info("tx_to_process--> " + str(payments))
        for trans in self:
            if trans.payment_id:
    ...
    def _set_transaction_cancel(self):
        _logger.info("_set_transaction_cancel======")
    ...
    def _set_transaction_error(self, msg):
        _logger.info("_set_transaction_error======")
    ...
    def _post_process_after_done(self):
        _logger.info("_post_process_after_done======")
    ...
    def _cron_post_process_after_done(self):
        _logger.info("_cron_post_process_after_done======")
        if not self:
